...
imgMatrix1 = imread('TP2gray10per.png');                                %读取图像
...
imgMatrix2 = imread('rice6per.png');
...
imgMatrix3 = imread('cameraman6per.tif');
...
imgMatrix4 = imread('lena5perG.jpg');
